...
def getData(object_code_new):
    ...
    floor_path = room_floor+'\\' if room_floor != '' else ''
    num_path = room_num+'' if room_num != '' else ''
    folder_path = do_path + si_path + dong_path + li_path + type_path + jibun_path + building_name_path + floor_path + num_path

    print (folder_path)
    print("test: "+ room_area1)
