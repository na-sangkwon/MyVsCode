...
def macro(data, user):
    ...
    try:
        ...
        for item in list_items:
            ...
            if 대장별개수 == '1':
                ...
                if len(visible_divs) == 1:
                    ...
                    e_container = visible_divs[0].find_element(By.CSS_SELECTOR, 'div[ref="eContainer"]')
                    # 해당 요소 클릭
                    e_container.click()
        #신청할민원담기 클릭
        ...
        신청하기버튼 = WebDriverWait(driver, 10).until(
            EC.element_to_be_clickable((By.CSS_SELECTOR, '#container > div.content > div > div.btns > button.btnNext.btnSolid.btnLarge.btn_blue'))
        )
        신청하기버튼.click()
        #일반건축물 클릭    
        pyautogui.alert("확인?")
