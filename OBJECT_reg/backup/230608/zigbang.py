...
def macro(data, user):
    ...
    if manager == '별도': 
        ...
        print("관리비없음 체크")
        if building_purpose == '단독주택':
            driver.find_element(By.CSS_SELECTOR, '#item_form > section:nth-child(10) > div > div:nth-child(4) > div.sc-gipzik.bEek > div.sc-jhAzac.fbSTfE > div:nth-child(2) > label > span').click()
        else: 
            driver.find_element(By.CSS_SELECTOR, '#item_form > section:nth-child(10) > div > div:nth-child(3) > div.sc-gipzik.bEek > div.sc-jhAzac.fbSTfE > div:nth-child(2) > label > span').click()
    ...
    if building_purpose == '단독주택':
        ...
        if rdate_day > today:
            ...
            # driver.find_element(By.CSS_SELECTOR, '#item_form > section:nth-child(10) > div > div:nth-child(7) > div.sc-gipzik.bEek > div.sc-iQNlJl.gvlab.sc-jhAzac.fbSTfE > div:nth-child(1) > div > label > span').click() #즉시입주 클릭
