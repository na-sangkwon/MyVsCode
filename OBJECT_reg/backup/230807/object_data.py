...
def getData(object_code_new, userid, userpw):
    ...
    if num_rows == 0:
        ...
        land_jibung = l_res[0]['land_jibung'].decode('utf8') #지번그룹
        representing_jimok = l_res[0]['representing_jimok'].decode('utf8') #대표지목
        representing_purpose = l_res[0]['representing_purpose'].decode('utf8') #용도지역
        land_road = l_res[0]['land_road'].decode('utf8') #접한도로
