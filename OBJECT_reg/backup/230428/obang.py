...
def macro(data, user):
    ...
    if obang_code == '' :
        ...
        if driver.find_element(By.XPATH, '//*[@id="full_price_area"]').is_displayed():
            ...
            print("거짓입니다.")
        driver.find_element(By.XPATH, '//*[@id="monthly_rent_deposit"]').send_keys(obinfo_deposit1) #월세의 보증금1
        ...
        if driver.find_element(By.XPATH, '//*[@id="law_area"]').is_displayed() : driver.find_element(By.XPATH, '//*[@id="law_area"]').send_keys(basic_area2)
