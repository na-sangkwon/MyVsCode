...
def macro(data, user):
    ...
    if room_direction != '선택' : selectOption('//*[@id="item_form"]/section[2]/div/div[6]/div[2]/div[1]/div[2]/div/select', room_direction)
            ...
            if 기준div in sibling_divs:
                ...
                for radio in radio_elements:
                    ...
                    if radio_text == 선택할텍스트:
                        ...
                        WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, f"//*[contains(text(), '{radio_text}')]"))).click()
    ...
    if '엘리베이터' in building_option:
        ...
        # driver.find_element(By.CSS_SELECTOR, '#item_form > section:nth-child(10) > div > div:nth-child(3) > div:nth-child(2) > div').click()
    else:
    ...
    if manager == '별도': 
        driver.find_element(By.CSS_SELECTOR, '#item_form > section:nth-child(10) > div > div:nth-child(3) > div.sc-csuQGl.hdlHHX > div.sc-kEYyzF.gjnHms > div > input').send_keys(mmoney)
    elif manager == '없음':
        print("관리비없음 체크")
        driver.find_element(By.CSS_SELECTOR, '#item_form > section:nth-child(10) > div > div:nth-child(3) > div.sc-csuQGl.hdlHHX > label:nth-child(2) > input[type=checkbox]').click()
    elif manager == '':
        print("관리비확인불가 체크")  
        driver.find_element(By.CSS_SELECTOR, '#item_form > section:nth-child(10) > div > div:nth-child(3) > div.sc-csuQGl.hdlHHX > label:nth-child(3) > input[type=checkbox]').click()  
