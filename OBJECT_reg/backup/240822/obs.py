...
#상세정보
        ...
        if trading != '':
            ...
            if main_area : object_detail += ('<p>' + f'● 대지면적: {land_totarea}㎡ (약{main_area_pyeong}평)' + '</p>') if float(main_area) > 0 else ''
        ...
        if tr_target != '토지' : 
            object_detail += ('<p>' + f'ㅇ {building_trmemo}' + '</p>') if building_trmemo else ''
            object_detail += ('<p>' + f'ㅇ {building_memo}' + '</p>') if building_memo else ''
        if tr_target == '층호수' : 
            object_detail += ('<p>' + f'ㅇ {room_memo}' + '</p>') if room_memo else ''
        object_detail += '<p>' + 'ㅇ&nbsp;' + '</p>'
        object_detail += '<p>' + 'ㅇ&nbsp;' + '</p>'
