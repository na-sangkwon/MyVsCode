...
def macro(data, user):
    ...
    selectOption('//*[@id="item_form"]/section[2]/div/div[6]/div[2]/div/div[1]/div/select', room_direction)
    #화장실수
    print("room_bcount",room_bcount)
    selectOption('//*[@id="item_form"]/section[2]/div/div[7]/div[2]/div[1]/select', room_bcount)
    #사용승인일
    ...
    if building_parking == '있음' : 
        if building_purpose == '단독주택':
            #일반건물
            clickLabel('#item_form > section:nth-child(10) > div > div:nth-child(2) > div.sc-gipzik.bEek > div > div:nth-child(1) > div', '가능')
        else:  
            #집합건물
            clickLabel('#item_form > section:nth-child(10) > div > div:nth-child(1) > div.sc-gipzik.bEek > div > div:nth-child(1) > div', '가능')
    ...
    if '엘리베이터' in building_option:
        ...
        if building_purpose == '단독주택':
            driver.find_element(By.CSS_SELECTOR, '#item_form > section:nth-child(10) > div > div:nth-child(3) > div.sc-gipzik.bEek > div').click() #있음 클릭
        else: 
            driver.find_element(By.CSS_SELECTOR, '#item_form > section:nth-child(10) > div > div:nth-child(2) > div.sc-gipzik.bEek > div').click() #있음 클릭
    # pyautogui.alert('ㄱㄱ?')
    #관리비
    if manager == '별도': 
        if building_purpose == '단독주택':
            driver.find_element(By.CSS_SELECTOR, '#item_form > section:nth-child(10) > div > div:nth-child(4) > div.sc-gipzik.bEek > div.sc-jhAzac.fbSTfE > div:nth-child(1) > div > div > input').send_keys(mmoney)    
        else:         
            driver.find_element(By.CSS_SELECTOR, '#item_form > section:nth-child(10) > div > div:nth-child(3) > div.sc-gipzik.bEek > div.sc-jhAzac.fbSTfE > div:nth-child(1) > div > div > input').send_keys(mmoney)
    else:
        print("관리비없음 체크")
        if building_purpose == '단독주택':
            driver.find_element(By.CSS_SELECTOR, '#item_form > section:nth-child(10) > div > div:nth-child(4) > div.sc-gipzik.bEek > div.sc-jhAzac.fbSTfE > div:nth-child(2) > label > input[type=checkbox]').click()
        else: 
            driver.find_element(By.CSS_SELECTOR, '#item_form > section:nth-child(10) > div > div:nth-child(3) > div.sc-gipzik.bEek > div.sc-jhAzac.fbSTfE > div:nth-child(2) > label > input[type=checkbox]').click()
        
    #관리비 포함 항목
    if building_purpose == '단독주택':
        clickLabel('#item_form > section:nth-child(10) > div > div:nth-child(5) > div.sc-gipzik.bEek > div', reNaming_commalist(mlist))
    else:     
        clickLabel('#item_form > section:nth-child(10) > div > div:nth-child(4) > div.sc-gipzik.bEek > div', reNaming_commalist(mlist))
    
    print("room_option:", room_option)
    print(reNaming_commalist(room_option))
    #옵션
    if building_purpose == '단독주택':
        clickLabel('#item_form > section:nth-child(10) > div > div:nth-child(6) > div.sc-gipzik.bEek > div', reNaming_commalist(room_option))
    else:     
        clickLabel('#item_form > section:nth-child(10) > div > div:nth-child(5) > div.sc-gipzik.bEek > div', reNaming_commalist(room_option))
    ...
    if building_purpose == '단독주택':
        if  manager == '별도': #월세일 경우
            ...
            if rdate_day > today:
                ...
                # driver.find_element(By.CSS_SELECTOR, '#item_form > section:nth-child(10) > div > div:nth-child(7) > div.sc-gipzik.bEek > div.sc-iQNlJl.gvlabC.sc-jhAzac.fbSTfE > div:nth-child(2) > div > div > div > label > span').click() #날짜선택클릭
                # # 변수 rdate_day의 값을 가져와서 input 태그의 value 속성으로 설정
                # change_day = "2023. 06. 06 이후"  # 임의의 날짜 값
                # input_element = driver.find_element(By.CSS_SELECTOR, '#item_form > section:nth-child(10) > div > div:nth-child(7) > div.sc-gipzik.bEek > div.sc-iQNlJl.gvlabC.sc-jhAzac.fbSTfE > div:nth-child(2) > div.react-datepicker-wrapper > div > div > label > input[type=radio]')
                # driver.execute_script("arguments[0].value = arguments[1];", input_element, change_day)        
            else:
                print("rdate는 오늘 이전의 날짜입니다.")   
                driver.find_element(By.CSS_SELECTOR, '#item_form > section:nth-child(10) > div > div:nth-child(7) > div.sc-gipzik.bEek > div.sc-iQNlJl.gvlabC.sc-jhAzac.fbSTfE > div:nth-child(1) > div > label > span').click() #즉시입주 클릭
        else:   
            if rdate_day > today:
                print("rdate는 오늘 이후의 날짜입니다.")    
            else:
                print("rdate는 오늘 이전의 날짜입니다.")   
                driver.find_element(By.CSS_SELECTOR, '#item_form > section:nth-child(10) > div > div:nth-child(6) > div.sc-gipzik.bEek > div.sc-iQNlJl.gvlabC.sc-jhAzac.fbSTfE > div:nth-child(1) > div > label > span').click() #즉시입주 클릭
        ...
        if  manager == '별도':
            ...
            if rdate_day > today:
                ...
                print("rdate는 오늘 이전의 날짜입니다.")   
                # driver.find_element(By.CSS_SELECTOR, '#item_form > section:nth-child(10) > div > div:nth-child(6) > div.sc-gipzik.bEek > div.sc-iQNlJl.gvlabC.sc-jhAzac.fbSTfE > div:nth-child(1) > div > label > span').click() #즉시입주 클릭
                driver.find_element(By.CSS_SELECTOR, '#item_form > section:nth-child(10) > div > div:nth-child(5) > div.sc-gipzik.bEek > div.sc-iQNlJl.gvlabC.sc-jhAzac.fbSTfE > div:nth-child(1) > div > label > span').click() #즉시입주 클릭
