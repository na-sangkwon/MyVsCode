...
def macro(data, user):
    ...
    if obang_code == '' :
        ...
        # print(driver.find_element(By.CSS_SELECTOR, "//*[@id='product_form]/div[1]/div[2]/div[2]/div[3]/div[2]/div/div").text)
        if driver.find_element(By.XPATH, '//*[@id="full_price_area"]').is_displayed() and (obinfo_rent1=='' or obinfo_rent1=='0'): driver.find_element(By.XPATH, '//*[@id="full_rent_price"]').send_keys(obinfo_deposit1) #전세의 보증금1
        # if driver.find_element(By.XPATH, '//*[@id="full_price_area"]').is_displayed():
        #     print("참입니다.")
        # else:
        #     print("거짓입니다.")
        if driver.find_element(By.XPATH, '//*[@id="monthly_rent_deposit"]').is_displayed(): driver.find_element(By.XPATH, '//*[@id="monthly_rent_deposit"]').send_keys(obinfo_deposit1) #월세의 보증금1
        if driver.find_element(By.XPATH, '//*[@id="monthly_rent_price"]').is_displayed(): driver.find_element(By.XPATH, '//*[@id="monthly_rent_price"]').send_keys(obinfo_rent1) #월세1
        # 관리내역
...
#침실과 욕실 값이 안들어가짐  
            Select(driver.find_element(By.XPATH, '//*[@id="bedcnt"]')).select_by_value(basic_rcount) #침실
            Select(driver.find_element(By.XPATH, '//*[@id="bathcnt"]')).select_by_value(basic_bcount) #욕실
