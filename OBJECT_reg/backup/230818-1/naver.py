...
#기본정보
    ...
    # pyautogui.alert("go?")
    if data['landData'][0]['land_li']!='': 
        WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, '//*[@id="ri"]'))).send_keys(data['landData'][0]['land_li'])
        # driver.find_element(By.XPATH, '//*[@id="ri"]').send_keys(data['landData'][0]['land_li']) # 
    ...
    time.sleep(0.5); print("jibun ok:", data['landData'][0]['land_jibun'])
    driver.find_element(By.XPATH, '//*[@id="address2"]').send_keys(data['landData'][0]['land_jibun']) # 
...
#시설정보
        ...
        # find_Maintag('//*[@id="spc1_mark"]','span','현재용도','//*[@id="cusage"]','input',land_purpose) #현재용도
