...
#가격정보
    ...
    #현월세금
    if driver.find_element(By.XPATH, '//*[@id="in_amt_sell"]').is_displayed() and obinfo_rent1 !='' : driver.find_element(By.XPATH, '//*[@id="in_amt_sell"]').send_keys(obinfo_rent1) 
    #현보증금
    if driver.find_element(By.XPATH, '//*[@id="in_amt_sell"]').is_displayed() and obinfo_deposit1 !='' : driver.find_element(By.XPATH, '//*[@id="in_amt_sell"]').send_keys(obinfo_deposit1) 
    #융자금
